/*
 * Jamlib-FTX1 GUI - Graphical interface for Hamlib daemon
 * Copyright (c) 2025 by Terrell Deppe (KJ5HST)
 */
package com.yaesu.jamlib.gui;
...
public class JamlibGUI extends JFrame {
    ...
    private void showAbout() {
        String message = "Jamlib-FTX1 GUI v" + VERSION + "\n\n" +
                "Hamlib-compatible daemon for Yaesu FTX-1\n\n" +
                "Copyright (c) 2025 Terrell Deppe (KJ5HST)\n\n" +
                "Licensed under LGPL";
        JOptionPane.showMessageDialog(this, message, "About Jamlib-FTX1",
