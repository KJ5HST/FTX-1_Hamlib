...
import com.yaesu.hamlib.audio.AudioDeviceInfo;
import com.yaesu.hamlib.audio.AudioDeviceManager;
    ...
    public String getWSJTXInstructions() {
        ...
        return String.format("""
            ...
            5. Configure radio connection:
               ...
               - Network Server: [ftx1-hamlib server IP]:4532
               - Example: 192.168.1.100:4532

            6. Click "Test CAT" to verify connection

            7. Start this audio client and connect to:
               [ftx1-hamlib server IP]:4533

            The audio path will be:
            FTX-1 Radio <-> ftx1-hamlib Server <-> This Client <-> Virtual Audio <-> WSJT-X
